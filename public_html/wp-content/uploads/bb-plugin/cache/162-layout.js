...
var wpAjaxUrl='http://www.ewebtechs.com/wp-admin/admin-ajax.php';var flBuilderUrl='http://www.ewebtechs.com/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://www.ewebtechs.com/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://www.ewebtechs.com/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
$('.fl-node-575b30d12d5d0 .fl-mosaicflow-content').one('mosaicflow-filled',function(){var hash=window.location.hash.replace('#','');if(hash!=''){FLBuilderLayout._scrollToElement($('#'+hash));}
