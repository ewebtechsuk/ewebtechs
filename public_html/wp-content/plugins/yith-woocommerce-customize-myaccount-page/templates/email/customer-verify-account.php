...
<?php /* translators: %s Customer first name */ ?>
	<p><?php printf( esc_html__( 'Hi %s,', 'yith-woocommerce-customize-myaccount-page' ), esc_html( has_filter( 'woocommerce_is_email_preview' ) ? 'johndoe' : stripslashes( $customer->user_login ) ) ); ?></p>
<?php /* translators: %1$s: Site title */ ?>
	<p><?php printf( esc_html__( 'Thanks for creating an account on %1$s.', 'yith-woocommerce-customize-myaccount-page' ), esc_html( $blogname ) ); ?></p>
