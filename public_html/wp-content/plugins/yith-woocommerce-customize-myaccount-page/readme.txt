...
== Version 4.20.0 === Released on 11 June 2025

* New: support for WooCommerce 9.9
* New: support for WooCommerce Email Preview feature
* Update: YITH plugin framework

== Version 4.19.0 === Released on 8 April 2025

* New: support for WordPress 6.8
* Update: YITH plugin framework

== Version 4.18.0 === Released on 18 March 2025

* New: support for WooCommerce 9.8
* Update: YITH plugin framework

== Version 4.17.0 === Released on 12 February 2025

* New: support for WooCommerce 9.7
* Update: YITH plugin framework

== Version 4.16.0 === Released on 21 January 2025

* New: support for WooCommerce 9.6
* Update: YITH plugin framework

== Version 4.15.0 === Released on 5 December 2024

* New: support for WooCommerce 9.5
* Update: YITH plugin framework

== Version 4.14.0 === Released on 6 November 2024

* New: support for WordPress 6.7
* New: support for WooCommerce 9.4
* Update: YITH plugin framework

== Version 4.13.0 === Released on 3 September 2024

* New: support for WooCommerce 9.3
* Update: YITH plugin framework

== Version 4.12.0 === Released on 7 August 2024

* New: support for WooCommerce 9.2
* Update: YITH plugin framework

== Version 4.11.0 === Released on 17 July 2024

* New: support for WordPress 6.6
* New: support for WooCommerce 9.1
* Update: YITH plugin framework

== Version 4.10.0 === Released on 19 June 2024

* New: support for WooCommerce 9.0
* Update: YITH plugin framework

== Version 4.9.0 === Released on 24 May 2024

* New: support for WooCommerce 8.9
* Update: YITH plugin framework

== Version 4.8.0 === Released on 17 April 2024

* New: support for WooCommerce 8.8
* Update: YITH plugin framework

== Version 4.7.0 === Released on 21 March 2024

* New: support for WordPress 6.5
* New: support for WooCommerce 8.7
* Update: YITH plugin framework
* Dev: new filter "yith_wcmap_dest_path_avatar_image"

== Version 4.6.0 === Released on 19 February 2024

* New: support for WooCommerce 8.6
* Update: YITH plugin framework

== Version 4.5.0 === Released on 23 January 2024

* New: support for WooCommerce 8.5
* Update: YITH plugin framework

== Version 4.4.0 === Released on 17 December 2023

* New: support for WooCommerce 8.4
* New: integration with YITH Pre-Order for WooCommerce
* Update: YITH plugin framework

== Version 4.3.0 === Released on 10 November 2023
