...
class HMWPP_Models_Uniquelogin {
	...
	public function init() {
		$this->expires = array(
			'hour'     => array(
				'label'     => esc_html__( 'One Hour', 'hide-my-wp-pack' ),
				'timestamp' => HOUR_IN_SECONDS
			),
			'3_hours'  => array(
				'label'     => esc_html__( 'Three Hours', 'hide-my-wp-pack' ),
				'timestamp' => HOUR_IN_SECONDS * 3
			),
			'day'      => array(
				'label'     => esc_html__( 'One Day', 'hide-my-wp-pack' ),
				'timestamp' => DAY_IN_SECONDS
			),
			'3_days'   => array(
				'label'     => esc_html__( 'Three Days', 'hide-my-wp-pack' ),
				'timestamp' => DAY_IN_SECONDS * 3
			),
			'week'     => array(
				'label'     => esc_html__( 'One Week', 'hide-my-wp-pack' ),
				'timestamp' => WEEK_IN_SECONDS
			),
			'month'    => array(
				'label'     => esc_html__( 'One Month', 'hide-my-wp-pack' ),
				'timestamp' => MONTH_IN_SECONDS
			),
			'halfyear' => array(
				'label'     => esc_html__( 'Six Months', 'hide-my-wp-pack' ),
				'timestamp' => ( 6 * MONTH_IN_SECONDS )
			),
			'year'     => array(
				'label'     => esc_html__( 'One Year', 'hide-my-wp-pack' ),
	...
	public function loginHtml( $error_msg = '' ) {
        ...
        <div id="unique_login_wrap">
            ...
            <div id="unique_login">
                <input type="button" name="unique_login_button" id="unique_login_button" value="<?php echo esc_attr__( 'Login using a magic link', 'hide-my-wp-pack' ) ?>">
            </div>
        </div>
        <div id="unique_login_form">
            ...
            <p>
                ...
                <input type="text" name="user_email" id="user_email" class="input" value="<?php echo esc_attr( HMWPP_Classes_Tools::getValue( 'log' ) ); ?>" size="20" autocapitalize="off" autocomplete="username" required="required"/>
                <input type="hidden" name="redirect_to" value="<?php echo esc_attr( $redirect_to ); ?>"/>
            </p>
            <p class="submit">
                <input type="submit" id="unique_login_submit" value="<?php echo esc_attr__( 'Send', 'hide-my-wp-pack' ); ?>"/>
                <input type="button" id="unique_login_cancel" value="< <?php echo esc_attr__( 'Back', 'hide-my-wp-pack' ); ?>"/>
            </p>
        </div>
        <style>
