...
class TransStrings
{
    public static function getTransStrings()
    {
        return [
            ...
            'OpenAI ChatGPT Integration'    => __('OpenAI ChatGPT Integration', 'fluent-support'),
            'The OpenAI ChatGPT API can be used to generate and enhance responses.'    => __('The OpenAI ChatGPT API can be used to generate and enhance responses.', 'fluent-support'),
            'Get OpenAI ChatGPT API Keys'    => __('Get OpenAI ChatGPT API Keys', 'fluent-support'),
            'Please click on this link to get API keys from OpenAI ChatGPT.'    => __('Please click on this link to get API keys from OpenAI ChatGPT.', 'fluent-support'),
            'Verify OpenAI'    => __('Verify OpenAI', 'fluent-support'),
