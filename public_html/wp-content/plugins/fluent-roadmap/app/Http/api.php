...
$router->prefix('roadmaps')->withPolicy('PublicPolicy')->group(function ($router) {
    ...
    $router->post('{board_id}/ideas/{idea_id}/comments', 'RoadmapController@addComment')
        ->int('board_id')
        ->int('idea_id');
    ...
    $router->get('{board_id}/day-wise-ideas', 'RoadmapController@getDayWiseIdeasReports')->int('board_id');
    $router->get('{board_id}/popular-ideas', 'RoadmapController@getPopularIdeas')->int('board_id');
    $router->post('{board_id}/idea/{idea_id}/change-stage', 'RoadmapController@changeIdeaStage')
        ->int('board_id')
        ->int('idea_id');
});
