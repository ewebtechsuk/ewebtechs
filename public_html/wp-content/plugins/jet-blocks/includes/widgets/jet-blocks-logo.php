...
class Jet_Blocks_Logo extends Jet_Blocks_Base {
	...
	public function __get_logo_image() {
		...
		// Retina (2x) image
		$retina_id = isset( $settings['logo_image_2x']['id'] ) ? $settings['logo_image_2x']['id'] : false;
		$retina_src = '';
		if ( $retina_id ) {
			$retina_src = Group_Control_Image_Size::get_attachment_image_src( $retina_id, 'logo_image_2x', $settings );
		}
