...
class Bootstrap
{
    ...
    public function maybeBookingOrderStatusChanged($orderId, $from, $to, $order)
    {
        ...
        if (in_array($to, $paidStatuses)) {
            ...
            $this->maybeUpdateChildBookings($booking, $calendarEvent, $order, $to);

            do_action('fluent_booking/log_booking_activity', $this->getSuccessLog($booking->id, $order, $to));
    ...
    private function maybeUpdateChildBookings($booking, $calendarEvent, $order, $to)
    {
        ...
        foreach ($childBookingIds as $childBookingId) {
            ...
            do_action('fluent_booking/log_booking_activity', $this->getSuccessLog($childBookingId, $order, $to));
        }
    }

    private function getSuccessLog($bookingId, $order, $to)
    {
        return [
