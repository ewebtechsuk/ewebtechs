...
function learndash_mark_complete_process() {
	 ...
	 * @since 4.21.4
	 *
	 * @param boolean $redirect_immediately Whether to redirect the user immediately. Default false.
	 *
	 * @return boolean Returns true if the user should be redirected immediately, otherwise false.
	 */
	if ( apply_filters( 'learndash_step_completed_redirect_immediately', false ) ) {
